    ...
    <nav className="bg-blue-500 p-4" style={{ boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)' }}>
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center">
          ...
          <Link to="/about" className="text-white text-lg mr-6 hover:text-gray-200">About</Link>
          <Link to="/services" className="text-white text-lg mr-6 hover:text-gray-200">Services</Link>
          ...
          <Link to="/signup" className="text-white text-lg mr-6 hover:text-gray-200">Signup</Link>
        </div>
        <div className="md:hidden">
          ...
          {showMenu && (
            <div className="absolute top-16 right-0 bg-blue-500 text-white rounded-lg shadow-md p-2">
              ...
              <Link to="/about" className="block py-1 hover:text-gray-200">About</Link>
