    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center">
          <Link to="/" className="text-white text-lg mr-6 hover:text-gray-200">
            Home
          </Link>
          <Link
            to="/aboutus"
        ...
        <div className="md:hidden">
          ...
          {showMenu && (
            <div className="absolute top-16 right-0 bg-blue-500 text-white rounded-lg shadow-md p-2">
              ...
              <Link to="/aboutus" className="block py-1 hover:text-gray-200">
                About Us
              </Link>
              ...
              <Link to="/login" className="block py-1 hover:text-gray-200">
                Login
              </Link>
              <Link to="/signup" className="block py-1 hover:text-gray-200">
                Signup
              </Link>
            </div>
          )}
