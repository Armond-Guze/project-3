  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md border border-gray-400 mt-4">
      ...
      <p className="text-lg">
        ...
        carefully before using the Trip Junkie website (the "service") operated
        by Trip Junkie.
      </p>
      <p className="text-lg">
      ...
      <h2 className="text-xl font-bold my-4">1. Accounts</h2>
      <p className="text-lg">
      ...
      <h2 className="text-xl font-bold my-4">2. Intellectual Property</h2>
      <p className="text-lg">
        The service and its original content, features, and functionality are
        and will remain the exclusive property of Trip Junkie and its licensors.
        The service is protected by copyright, trademark, and other laws of both
        the United States and foreign countries.
      </p>
      <h2 className="text-xl font-bold my-4">3. Limitation of Liability</h2>
      <p className="text-lg">
        In no event shall Trip Junkie, nor its directors, employees, partners,
